        ...
        if (
          ...
          if (hand.length > 0) {
            ...
            if (gesture && gesture.gestures && gesture.gestures.length > 0) {
              const gestureNames = gesture.gestures.map((gesture) => gesture.name);
              const gestureScores = gesture.gestures.map((gesture) => gesture.score);

              // Find the index of the gesture with the maximum score
              const maxScoreIndex = gestureScores.indexOf(Math.max(...gestureScores));
      ...
      <header className="App-header">
        ...
        {browserSupportsSpeechRecognition && (
          <div className="microphone-container" style={{  }}>
            ...
            <button onClick={SpeechRecognition.startListening} className="start">Start</button>
        ...
        <div className="colored-box" style={{ boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.6)"}}>
